...
إذا كنت تريد طريقه انشاء الكونفق يدويا ولك معرفه باللغه الانجليزي [هنا ](https://dortania.github.io/OpenCore-Install-Guide/config-laptop.plist/kaby-lake.html)رابط يشرح كيفيه انشاء الكونفق للجيل السابع  لللابتوبات
