...
![](https://dortania-mirror.tutorial.هاكنتوش.com/images/config/config-laptop.plist/skylake/DeviceProperties.png#zoom){: style="width:800px"; loading=lazy }
...
![](https://dortania-mirror.tutorial.هاكنتوش.com/images/config/config-laptop.plist/skylake/smbios.png#zoom){: style="width:800px"; loading=lazy }
...
???+ note "Generic"
	...
	```bash
	#######################################################
	#            MacBookPro13,3 SMBIOS Info               #
	#######################################################

	Type:         MacBookPro13,3
	Serial:       C02VFEYDGTFN
	Board Serial: C02738404CDHCF98C
	SmUUID:       53869C38-1792-48CB-892A-FD2353C8056C
	```
