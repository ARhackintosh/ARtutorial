---
description: شرح كيفيه انشاء كونفق اوبن كور لمعالجات انتل الجيل السادس على المكتبي وكافه الخيارات الضروريه.
comments: true
---
...
![](https://dortania-mirror.tutorial.هاكنتوش.com/images/config/config.plist/skylake/DeviceProperties.png){: style="width:800px"; loading=lazy }
...
???+ note "PciRoot(0x0)/Pci(0x2,0x0)"
	...
	اذا كان لديك كرت P530 فهو غير مدعوم من الماك بشكل رسمي لذلك ستحتاج تغيير اسمه, اضف الاتي للكونفق تحت `PciRoot(0x0)/Pci(0x2,0x0)` :
...
![](https://dortania-mirror.tutorial.هاكنتوش.com/images/config/config.plist/skylake/smbios.png#zoom){: style="width:800px"; loading=lazy }
...
???+ note "Generic"
	...
	بالنسبه للموديل الجهاز (SMBIOS) للجيل السادس استخدم `iMac17,1`
	...
	Type:         iMac17,1
	Serial:       C02TT5Y9GG7L
	Board Serial: C02723130J9GPF7UE
	SmUUID:       205CE3D5-C3F0-455D-A2C4-440453B3FF71
	```
