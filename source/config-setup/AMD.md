...
![kernel](https://dortania-mirror.tutorial.هاكنتوش.com/images/config/AMD/kernel.png#zoom){: style="width:800px"; loading=lazy }
...
![](https://dortania-mirror.tutorial.هاكنتوش.com/images/config/config-universal/iMacPro-smbios.png#zoom){: style="width:800px"; loading=lazy }
