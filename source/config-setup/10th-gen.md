...
![](https://dortania-mirror.tutorial.هاكنتوش.com/images/config/config.plist/commetlake/DeviceProperties.png){: style="width:800px"; loading=lazy }
...
![](https://dortania-mirror.tutorial.هاكنتوش.com/images/config/config.plist/cometlake/smbios.png#zoom){: style="width:800px"; loading=lazy }
...
???+ note "Generic"
	...
	Type:         iMac20,2
	Serial:       C02DG2ZBJV3Q
	Board Serial: C020393004NLNV9CB
	SmUUID:       5180F4BD-BDF9-4695-BC58-4BB0B155DD75
	```
