...
![](https://dortania-mirror.tutorial.هاكنتوش.com/images/config/config.plist/ivy-bridge/smbios.png){: style="width:800px"; loading=lazy }
...
???+ note "Generic"
	...
	كاتلينا او اقدم  (macOS Catalina 10.15)

	- `iMac13,1` يستخدم للاجهزه التي تستعمل كرت انتل لعرض الشاشه

	- `iMac13,2` اذا كنت ستسخدم كرت منفصل

	بيج سر (macOS Big Sur 11)

	- `iMac14,4` يستخدم للاجهزه التي تستعمل كرت انتل لعرض الشاشه
	...
	Type:         iMac15,1
	Serial:       C02PTLYYFY10
	Board Serial: C025233064NG2Y78C
	SmUUID:       8337B8DB-CB62-4D5A-ACB7-FE78438A664E
	```
