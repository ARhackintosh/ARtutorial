...
إذا كنت تريد طريقه انشاء الكونفق يدويا ولك معرفه باللغه الانجليزي [هنا ](https://dortania.github.io/OpenCore-Install-Guide/config-laptop.plist/icelake.html)رابط يشرح كيفيه انشاء الكونفق للجيل العاشر(ice lake)  لللابتوبات
