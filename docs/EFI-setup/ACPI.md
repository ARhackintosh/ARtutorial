...
- NVRAM ==SSDT==
	...
	- مذربوردات فئه 300 من انتل الفعليه (لا تشمل z370) لا تظهر شرائح FW بشكل صحيح في ال ACPI ويسبب مشاكل في ال ==NVRAM== 
	هذا ال ==SSDT== يقوم بحل هذه المشكلة

- Plugin type (SSDT-PLUG)
	- يقوم بتفعيل  التحكم بطاقه المعالج من النظام لمعالجات انتل من الجيل  الرابع فما فوق. **لايعمل على AMD**
